...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aged-math-f357
```

A live public deployment of this template is available at [https://aged-math-f357.templates.workers.dev](https://aged-math-f357.templates.workers.dev)
